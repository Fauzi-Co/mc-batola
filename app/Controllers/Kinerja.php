...
class Kinerja extends BaseController
{
    ...
    public function laporan()
    {
        ...
        // $sql = $db->query("SELECT * FROM rin11 WHERE id = 3");
        // dd($sql->getResult());
    ...
    public function edit($c_code)
    {
        ...
        return view('kinerja/input/' . 'ik_' . $c_code, $data);
    }
    ...
    public function update()
    {
        ...
        $bar = 'k' .  ucfirst(strtolower($arr['code'])) . 'Model';
        ...
        if ($arr['code'] == 'intel') {
            ...
            $in32 = $arr['gedung-12'] . '+' . $arr['gedung-22'] . '+' . $arr['gedung-32'];
