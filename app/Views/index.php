...
<script>
    ...
    ChartTemp.render(ChartData_bb_20, ChartTemp.options.no, "chart-bb-20", ChartTemp.type);
    // Chart Anggaran End script 2020

    // Chart Anggaran Scripts 2021
    // chart 1 intel 2021
    const ChartData_intel_21 = {
        labels: ["LPG", "PAKEM", "PENKUM", "JMS", ],
        datasets: [{
            fillColor: "rgba(255, 99, 132, 0.2",
            strokeColor: "rgba(255, 99, 132, 1)",
    ...
    ChartTemp.render(ChartData_intel_21, ChartTemp.options.no, "chart-a-intel-21", ChartTemp.type);
</script>

<script>
    // chart 2 pembinaan 2021
    function MoreChartOptions() {}
    const ChartData = {
    ...
    ChartTemp.render(ChartData, ChartTemp.options.no, "chart-pembinaan", ChartTemp.type);
</script>
...
<script>
    ...
    ChartTemp.render(ChartData, ChartTemp.options.no, "chart-pidum", ChartTemp.type);
</script>
...
<script>
    ...
    ChartTemp.render(ChartData, ChartTemp.options.no, "chart-pidsus", ChartTemp.type);
</script>
...
<script>
    ...
    ChartTemp.render(ChartData, ChartTemp.options.no, "chart-datun", ChartTemp.type);
</script>
...
<script>
    ...
    ChartTemp.render(ChartData, ChartTemp.options.no, "chart-bb", ChartTemp.type);
</script>
