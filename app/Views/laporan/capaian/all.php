        ...
        <div class="row mb-1">
            <div class="col-sm-12 text-center">
                <div class="col-12 mb-2 text-center">
                    <h5 style="text-transform: uppercase;">CAPAIAN ANGGARAN INTELIJEN, PEMBINAAN, PIDUM, PIDSUS, DATUN, DAN BB</h5>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                <div class="small-box ">
                                    ...
                                    <div class="inner">
                                        <canvas id="chart-intel" width="400" height="300" style="background-color:rgba(255,255,255,1.00);border-radius:0px;width:700px;height:400px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px"></canvas>
                                    </div>
                                    <div class="icon">
                            ...
                            <div class="col-md-4 text-center">
                                <div class="small-box ">
                                    ...
                                    <div class="inner">
                                        <canvas id="chart-pembinaan" width="400" height="300" style="background-color:rgba(255,255,255,1.00);border-radius:0px;width:700px;height:400px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px"></canvas>
                                    </div>
                                    <div class="icon">
                                        <i class="ion ion-bag"></i>
                                    </div>
                            ...
                            <div class="col-md-4 text-center">
                                <div class="small-box ">
                                    ...
                                    <div class="inner">
                                        <canvas id="chart-pidum" width="400" height="300" style="background-color:rgba(255,255,255,1.00);border-radius:0px;width:700px;height:400px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px"></canvas>
                                    </div>
                                    <div class="icon">
                                        <i class="ion ion-bag"></i>
                                    </div>
                            ...
                            <div class="col-md-4 text-center">
                                <div class="small-box ">
                                    ...
                                    <div class="inner">
                                        <canvas id="chart-pidsus" width="400" height="300" style="background-color:rgba(255,255,255,1.00);border-radius:0px;width:700px;height:400px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px"></canvas>
                                    </div>
                                    <div class="icon">
                                        <i class="ion ion-bag"></i>
                                    </div>
                            ...
                            <div class="col-md-4 text-center">
                                <div class="small-box ">
                                    ...
                                    <div class="inner">
                                        <canvas id="chart-datun" width="400" height="300" style="background-color:rgba(255,255,255,1.00);border-radius:0px;width:700px;height:400px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px"></canvas>
                                    </div>
                                    <div class="icon">
                                        <i class="ion ion-bag"></i>
                                    </div>
                            ...
                            <div class="col-md-4 text-center">
                                <div class="small-box ">
                                    ...
                                    <div class="inner">
                                        <canvas id="chart-bb" width="400" height="300" style="background-color:rgba(255,255,255,1.00);border-radius:0px;width:700px;height:400px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px"></canvas>
                                    </div>
                                    <div class="icon">
                                        <i class="ion ion-bag"></i>
                                    </div>
...
<script>
    ...
    DrawTheChart(ChartData, ChartOptions, "chart-intel", "Bar");
</script>
