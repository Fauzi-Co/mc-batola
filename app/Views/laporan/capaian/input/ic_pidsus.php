                                ...
                                <table class="table table-bordered table-hover text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" style="width:100%" name='lid-1' class="text-center" value="<?= explode('+', $c_hasil[0]['lid'])[0];  ?>">
                                            </td>

                                            <td>
                                                <input type="text" style="width:100%" name='lid-2' class="text-center" value="<?= explode('+', $c_hasil[0]['lid'])[1];  ?>">
                                            </td>

                                            <td>
                                                <input type="text" style="width:100%" name='lid-3' class="text-center" value="<?= explode('+', $c_hasil[0]['lid'])[2];  ?>">
                                            </td>

                                            <td>
                                                <input type="text" style="width:100%" name='dik-1' class="text-center" value="<?= explode('+', $c_hasil[0]['dik'])[0];  ?>">
                                            </td>

                                            <td>
                                                <input type="text" style="width:100%" name='dik-2' class="text-center" value="<?= explode('+', $c_hasil[0]['dik'])[1];  ?>">
                                            </td>

                                            <td>
                                                <input type="text" style="width:100%" name='dik-3' class="text-center" value="<?= explode('+', $c_hasil[0]['dik'])[2];  ?>">
                                            </td>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            <input type="text" style="width:100%" name='lid-12' class="text-center" value="<?= explode('+', $c_hasil[1]['lid'])[0];  ?>">
        </td>

        <td>
            <input type="text" style="width:100%" name='lid-22' class="text-center" value="<?= explode('+', $c_hasil[1]['lid'])[1];  ?>">
        </td>

        <td>
            <input type="text" style="width:100%" name='lid-32' class="text-center" value="<?= explode('+', $c_hasil[1]['lid'])[2];  ?>">
        </td>

        <td>
            <input type="text" style="width:100%" name='dik-12' class="text-center" value="<?= explode('+', $c_hasil[1]['dik'])[0];  ?>">
        </td>

        <td>
            <input type="text" style="width:100%" name='dik-22' class="text-center" value="<?= explode('+', $c_hasil[1]['dik'])[1];  ?>">
        </td>

        <td>
            <input type="text" style="width:100%" name='dik-32' class="text-center" value="<?= explode('+', $c_hasil[1]['dik'])[2];  ?>">
        </td>
...
<script>
    ...
    var ChartData = {
        ...
        datasets: [{
            ...
            data: [<?= explode('+', $c_hasil[0]['lid'])[0];  ?>, <?= explode('+', $c_hasil[0]['dik'])[0];  ?>, <?= explode('+', $c_hasil[0]['tut'])[0];  ?>, <?= explode('+', $c_hasil[0]['eks'])[0];  ?>, ],
            title: "Target"
        }, {
            ...
            markerShape: "circle",
            pointStrokeColor: "rgba(255,255,255,1.00)",
            data: [<?= explode('+', $c_hasil[0]['lid'])[1];  ?>, <?= explode('+', $c_hasil[0]['dik'])[1];  ?>, <?= explode('+', $c_hasil[0]['tut'])[1];  ?>, <?= explode('+', $c_hasil[0]['eks'])[1];  ?>, ],
            title: "Realisasi"
        }, {
            ...
            data: [<?= explode('+', $c_hasil[0]['lid'])[2];  ?>, <?= explode('+', $c_hasil[0]['dik'])[2];  ?>, <?= explode('+', $c_hasil[0]['tut'])[2];  ?>, <?= explode('+', $c_hasil[0]['eks'])[2];  ?>, ],
            title: "Sisa Anggaran"
        }, ]
    };
    ChartOptions = {
