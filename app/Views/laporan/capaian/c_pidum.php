...
<script>
    ...
    var ChartData = {
        ...
        datasets: [{
            ...
            markerShape: "circle",
            pointStrokeColor: "rgba(255,255,255,1.00)",
            data: [<?= explode('+', $c_hasil[1]['pratut'])[0];  ?>, <?= explode('+', $c_hasil[1]['tut'])[0];  ?>, <?= explode('+', $c_hasil[1]['eks'])[0];  ?>],
            title: "Target"
        }, {
            fillColor: "rgba(255,208,0,1)",
            strokeColor: "rgba(46,204,113,1)",
            ...
            markerShape: "circle",
            pointStrokeColor: "rgba(255,255,255,1.00)",
            data: [<?= explode('+', $c_hasil[1]['pratut'])[1];  ?>, <?= explode('+', $c_hasil[1]['tut'])[1];  ?>, <?= explode('+', $c_hasil[1]['eks'])[1];  ?>],
            title: "Realisasi"
        }, {
            fillColor: "rgba(255,0,0,1)",
            strokeColor: "rgba(155,89,182,1)",
            ...
            markerShape: "circle",
            pointStrokeColor: "rgba(255,255,255,1)",
            data: [<?= explode('+', $c_hasil[1]['pratut'])[2];  ?>, <?= explode('+', $c_hasil[1]['tut'])[2];  ?>, <?= explode('+', $c_hasil[1]['eks'])[2];  ?>],
            title: "Sisa Anggaran"
        }, ]
    };
    ChartOptions = {
