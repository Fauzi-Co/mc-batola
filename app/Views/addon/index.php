    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12 text-center">
                <h1 class="m-0">Selamat Datang di MediaCenter Batola</h1>
            </div>
    ...
    <div class="container-fluid">
                                  ...
                                  <div class="profile">
                                    <div class="profile-header">
                                      <div class="profile-img">
                                        <img src="<?= base_url(); ?>/img/profile/<?= $dp['foto']; ?>" alt="">
                                      </div>
                                    </div>
                                    <div class="profile-body">
                                      <a href="" class="nama"><?= $dp['nama']; ?></a>
                                      <p class="jabatan"><?= $dp['jabatan']; ?></p>
                                    </div>
                                  </div>

                                  <!-- <div class="img">
                                    <img src="<?= base_url(); ?>/img/profile/<?= $dp['foto']; ?>" style="height: 200px; width:200px">
                                  </div>
                                    <a class="users-list-name mt-2" href="#"><?= $dp['nama']; ?></a>
                                    <span class="users-list-date"><?= $dp['jabatan']; ?></span> -->
                                </li>
                            <?php endforeach; ?>
                        </ul>
            ...
            <div class="col-md-4">
                ...
                <div class="medsos-button">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text" onclick="window.open('#', '__blank').focus();">R.IN</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="medsos-button">
                    <div class="info-box mb-3">
                        <span class="info-box-icon bg-danger elevation-1"><img src="dist/img/CT_logo.png" alt=""></span>

                        <div class="info-box-content">
                            <span class="info-box-text" onclick="window.open('#', '__blank').focus();">McBatola</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="medsos-button">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text" onclick="window.open('#', '__blank').focus();">IndraSembilan</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">CAPAIAN ANGGARAN INTELIJEN, PEMBINAAN, PIDUM, PIDSUS, DATUN, DAN BB</h3>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">CAPAIAN KINERJA INTELIJEN, PEMBINAAN, PIDUM, PIDSUS, DATUN, DAN BB</h3>
                                        ...
                                        <div class="datepicker">
                                                ...
                                                <table class="table table-sm">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="picker-switch" data-action="pickerSwitch" colspan="5" title="Select Month">August 2021</th>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td data-action="selectDay" data-day="08/01/2021" class="day weekend">1</td>
                                                            <td data-action="selectDay" data-day="08/02/2021" class="day today">2</td>
                                                            <td data-action="selectDay" data-day="08/03/2021" class="day">3</td>
                                                            <td data-action="selectDay" data-day="08/04/2021" class="day">4</td>
                                                            <td data-action="selectDay" data-day="08/05/2021" class="day">5</td>
                                                            <td data-action="selectDay" data-day="08/06/2021" class="day">6</td>
                                                            <td data-action="selectDay" data-day="08/07/2021" class="day weekend">7</td>
                                                        </tr>
                                                        <tr>
                                                            <td data-action="selectDay" data-day="08/08/2021" class="day weekend">8</td>
                                                            <td data-action="selectDay" data-day="08/09/2021" class="day">9</td>
                                                            <td data-action="selectDay" data-day="08/10/2021" class="day">10</td>
                                                            <td data-action="selectDay" data-day="08/11/2021" class="day">11</td>
                                                            <td data-action="selectDay" data-day="08/12/2021" class="day">12</td>
                                                            <td data-action="selectDay" data-day="08/13/2021" class="day">13</td>
                                                            <td data-action="selectDay" data-day="08/14/2021" class="day weekend">14</td>
                                                        </tr>
                                                        <tr>
                                                            <td data-action="selectDay" data-day="08/15/2021" class="day weekend">15</td>
                                                            <td data-action="selectDay" data-day="08/16/2021" class="day">16</td>
                                                            <td data-action="selectDay" data-day="08/17/2021" class="day">17</td>
                                                            <td data-action="selectDay" data-day="08/18/2021" class="day">18</td>
                                                            <td data-action="selectDay" data-day="08/19/2021" class="day">19</td>
                                                            <td data-action="selectDay" data-day="08/20/2021" class="day">20</td>
                                                            <td data-action="selectDay" data-day="08/21/2021" class="day weekend">21</td>
                                                        </tr>
                                                        <tr>
                                                            <td data-action="selectDay" data-day="08/22/2021" class="day weekend">22</td>
                                                            <td data-action="selectDay" data-day="08/23/2021" class="day">23</td>
                                                            <td data-action="selectDay" data-day="08/24/2021" class="day">24</td>
                                                            <td data-action="selectDay" data-day="08/25/2021" class="day">25</td>
                                                            <td data-action="selectDay" data-day="08/26/2021" class="day">26</td>
                                                            <td data-action="selectDay" data-day="08/27/2021" class="day">27</td>
                                                            <td data-action="selectDay" data-day="08/28/2021" class="day weekend">28</td>
                                                        </tr>
                                                        <tr>
                                                            <td data-action="selectDay" data-day="08/29/2021" class="day weekend">29</td>
                                                            <td data-action="selectDay" data-day="08/30/2021" class="day">30</td>
                                                            <td data-action="selectDay" data-day="08/31/2021" class="day">31</td>
                                                            <td data-action="selectDay" data-day="09/01/2021" class="day new">1</td>
                                                            <td data-action="selectDay" data-day="09/02/2021" class="day new">2</td>
                                                            <td data-action="selectDay" data-day="09/03/2021" class="day new">3</td>
                                                            <td data-action="selectDay" data-day="09/04/2021" class="day new weekend">4</td>
                                                        </tr>
                                                        <tr>
                                                            <td data-action="selectDay" data-day="09/05/2021" class="day new weekend">5</td>
                                                            <td data-action="selectDay" data-day="09/06/2021" class="day new">6</td>
                                                            <td data-action="selectDay" data-day="09/07/2021" class="day new">7</td>
                                                            <td data-action="selectDay" data-day="09/08/2021" class="day new">8</td>
                                                            <td data-action="selectDay" data-day="09/09/2021" class="day new">9</td>
                                                            <td data-action="selectDay" data-day="09/10/2021" class="day new">10</td>
                                                            <td data-action="selectDay" data-day="09/11/2021" class="day new weekend">11</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class="datepicker-months" style="display: none;">
                                                <table class="table-condensed">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td colspan="7"><span data-action="selectMonth" class="month">Jan</span><span data-action="selectMonth" class="month">Feb</span><span data-action="selectMonth" class="month">Mar</span><span data-action="selectMonth" class="month">Apr</span><span data-action="selectMonth" class="month">May</span><span data-action="selectMonth" class="month">Jun</span><span data-action="selectMonth" class="month">Jul</span><span data-action="selectMonth" class="month active">Aug</span><span data-action="selectMonth" class="month">Sep</span><span data-action="selectMonth" class="month">Oct</span><span data-action="selectMonth" class="month">Nov</span><span data-action="selectMonth" class="month">Dec</span></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
...
<!-- Chart Anggaran Scripts -->

<script>
  // Global Variabel
  const pengaturanCards = {
    decimalSeparator: ".",
    thousandSeparator: ",",
    spaceLeft: 12,
    spaceRight: 12,
  ...
  const pengDataset = {
    fillColor: {
      target: "rgba(255, 99, 132, 0.2",
      realisasi: "rgba(54, 162, 235, 0.2)",
      sisa: "rgba(255, 206, 86, 0.2)",
    },
    strokeColor: {
      target: "rgba(255, 99, 132, 1)",
      realisasi: "rgba(54, 162, 235, 1)",
      sisa: "rgba(46,204,113,1)",
    } ,
    pointColor: {
      target: "rgba(52,152,219,1)",
      realisasi: "rgba(46,204,113,1)",
      sisa: "rgba(155,89,182,1)",
    },
    markerShape: {
      target:  "circle",
      realisasi:  "circle",
    ...
    pointStrokeColor: {
      target: "rgba(255,255,255,1.00)",
      realisasi: "rgba(255,255,255,1.00)",
      sisa: "rgba(255,255,255,1)",  
    },
  }

  // Chart 1`
  function MoreChartOptions_1() {}
  var ChartData_1 = {
  ...
  ChartOptions = pengaturanCards;
  DrawTheChart(ChartData_1, ChartOptions, "chart-intel", "Bar");
</script>
...
<!-- Chart Anggaran Scripts End -->

<!-- Chart Kinerja Scripts -->
<script>
    // Chart 7
    function MoreChartOptions() {}
    var ChartData = {
