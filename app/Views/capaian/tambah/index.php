                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active"><?= $code_rin; ?></li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        ...
                        <form method="POST" action="<?= base_url(); ?>/capaian/save" enctype="multipart/form-data">
                            <input type="hidden" value="<?= $code_rin; ?>" name="codekos">
                            <!-- /.card-header -->
                            <!-- Render Content -->
                            <?= $this->renderSection('page-data-tambah'); ?>
                            <!-- End Render Content -->
                            <!-- /.card-body -->
                        </form>
                    </div>
